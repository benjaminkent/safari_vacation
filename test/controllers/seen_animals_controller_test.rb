...
class SeenAnimalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seen_animal" do
    assert_difference('SeenAnimal.count') do
      post seen_animals_url, params: { seen_animal: { count_of_times_seen: @seen_animal.count_of_times_seen, location_of_last_seen: @seen_animal.location_of_last_seen, species: @seen_animal.species } }
    end
  ...
  test "should update seen_animal" do
    patch seen_animal_url(@seen_animal), params: { seen_animal: { count_of_times_seen: @seen_animal.count_of_times_seen, location_of_last_seen: @seen_animal.location_of_last_seen, species: @seen_animal.species } }
